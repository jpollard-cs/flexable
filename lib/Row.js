    ...
    return function (_ref) {
        ...
        var transformChildren = function transformChildren(_children, _passthroughProps) {
            return _react2.default.Children.map(_children, function (c, i) {
                ...
                return _react2.default.cloneElement(c, (0, _extends3.default)({ key: _key + '-cell-' + i }, _passthroughProps, columnDefinition, { rowData: rowData }));
            });
        };
        ...
        if (!children) {
            return _react2.default.createElement(
                ...
                includeVerticalScrollbar && _react2.default.createElement('div', { style: { width: 25 } })
            );
        }
